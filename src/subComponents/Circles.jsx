...
function Circles({ theme }) {
    ...
    return (
        ...
        <motion.div
            ...
            <div className={theme === "dark-mode" ? "md:rounded-full border border-[#F7AB0A] opacity-20 h-[600px] w-[650px] absolute mt-52 animate-ping" : "rounded-full border  border-[#333333] opacity-20 h-[600px] w-[650px] absolute mt-52 animate-ping"} />
